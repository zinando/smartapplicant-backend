...
from api.views import (ResumeParseView, TaskStatusView, StatsAPIView, ResumeDownloadView, ConversationContextAPIView,
...
urlpatterns = [
    ...
    path('api/user/conversation-context/', ConversationContextAPIView.as_view()),
