...
class AutomatedClients(models.Model):
    ...
    saved_video_plan= models.JSONField(null=True, blank=True)  # current video plan being worked on {"media_type": "image | video", "url": "string", "overlay_text": "string", "voice_over_text": "string", "duration": number, "transition": "fade | slide | none", "fade_in": number, "fade_out": number}
    created_at = models.DateTimeField(auto_now_add=True)
